...
<iframe src="figs/sdstudio-workflow.html" style="width:100%; height:420px; border:none;"></iframe>
...
![](figs/studio-build.gif){fig-align="center" width=100%}

## The [Preview]{.amber} Tab {.dark-centered .center}

![](figs/studio-preview.gif){fig-align="center" width=100%}

## The [Responses]{.amber} Tab - [Local]{.amber} Mode {.dark-centered .center}

![](figs/studio-responses-local.gif){fig-align="center" width=100%}

## The [Responses]{.amber} Tab - [DB]{.amber} Mode {.dark-centered .center}

![](figs/studio-responses-db.gif){fig-align="center" width=100%}

## [Studio]{.amber} Features {.dark-centered .center}

## [GUI]{.amber} Operations {.light-centered .center}

(Image here)

## Side-by-side [Code Scripts]{.amber} {.light-centered .center}

(Image here)

## [Modes]{.amber} and [Views]{.amber} {.light-centered .center}
