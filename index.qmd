...
## Recap of `surveydown` {.dark-centered .center}
...
## [Quarto]{.teal} is a publishing system {.light-centered .center}
...
## Wait a minute...<br>Quarto renders to [static]{.amber} html pages, right? {.dark-centered .center}

<br>

![](figs/batman-think.gif){fig-align="center" width=40%}

## [Shiny]{.amber} to the rescue! {.dark-centered .center}
...
## Wait a minute...<br>How do you store the response [data]{.amber}? {.dark-centered .center}

<br>

![](figs/superman-think.gif){fig-align="center" width=50% .purple-border}

## [PostgreSQL]{.amber} to the rescue! {.dark-centered .center}
...
## If it works in [Shiny]{.amber},<br>it works in `surveydown`. {.dark-centered .center style="font-size: 1.2em;"}
...
## Using `sdstudio`, You can... {.light-centered .center}

(Use Claude code to generate a chart showing the features of `sdstudio`)
...
## `surveydown` + `sdstudio` {.dark-centered .center style="font-size: 1.2em;"}
