...
## <span style="color: #FFB84D;">Studio</span> Workflow {.dark-centered .center}
...
## The <span style="color: #FFB84D;">Build</span> Tab {.light-centered .center}

![](figs/sdstudio-build.gif){fig-align="center" width=90% .purple-border}

## The <span style="color: #FFB84D;">Preview</span> Tab {.light-centered .center}

![](figs/sdstudio-preview.gif){fig-align="center" width=90% .purple-border}

## The <span style="color: #FFB84D;">Responses</span> Tab {.light-centered .center}

![](figs/sdstudio-data.gif){fig-align="center" width=90% .purple-border}

## <span style="color: #FFB84D;">Studio</span> Features {.dark-centered .center}

## <span style="color: #FFB84D;">GUI</span> Operations {.light-centered .center}

(Image here)

## Side-by-side <span style="color: #FFB84D;">Code Scripts</span> {.light-centered .center}

(Image here)

## <span style="color: #FFB84D;">Modes</span> and <span style="color: #FFB84D;">Views</span> {.light-centered .center}
