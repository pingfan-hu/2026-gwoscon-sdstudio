...
Thank you for participating in our research on super hero preferences and powers! This survey will help us understand what makes super heroes appealing to different people.
...
# Tell us about your super hero preferences
...
sd_question(
  type  = "mc_multiple",
  id    = "hero_qualities",
  label = "What qualities do you find most appealing in super heroes? (Select all that apply)",
  option = c(
...
sd_question(
  type  = "matrix",
  id    = "superhero_rating",
  label = "Rate these classic super heroes:",
  row = c(
...
sd_question(
  ...
  option = c(
    ...
    "No, but I watch super hero movies/TV" = "movies_only",
    "No, not really into comics or super hero media" = "not_into"
  )
)
```
...
sd_question(
  type  = "numeric",
  id    = "movies_watched",
  label = "Approximately how many super hero movies have you watched in the past year?"
)
```
...
sd_question(
  type  = "textarea",
  id    = "superhero_impact",
  label = "In your opinion, what positive impact do super heroes have on society and culture?",
  height = "100px"
)
```
...
Your responses help us understand how people connect with super hero stories and characters.
...
We're specifically looking for people who have some interest in super heroes for this survey. 
